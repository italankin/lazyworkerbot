...
class App implements UpdateHandler {
    ...
    App(String token, String hostname) {
        ...
        handlerManager = new HandlerManager(new StartCommandHandler())
                .add(new FinishActivityHandler(activityManager))
                .add(new CurrentActivityHandler(activityManager))
                .add(new NewActivityHandler(activityManager))
                .add(new TodayHandler(activityManager))
                .add(new DateHandler(activityManager))
                .add(new ShowActivityHandler(activityManager))
                .add(new LastActivitiesHandler(activityManager))
                .add(new DeleteActivityHandler(activityManager))
    }
